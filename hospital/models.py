...
class Appointment(models.Model):
    ...
    def add_patient_to_queue(self):
        OPDQueue.objects.create(hospital=self.hospital, patient=self.patient,doctor = self.doctor)
...
class OPDQueue(models.Model):
    hospital = models.ForeignKey(Hospital, on_delete=models.CASCADE)
    doctor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='doctor_opd_queue', null=True, blank=True)
    patient = models.ForeignKey(User, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
